      ...
      <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {ZONES.map((zone, i) => (
          ...
          >
            <Link
              href={zone.href}
              className="group block overflow-hidden rounded-3xl border border-steel-line bg-panel soft-shadow transition-transform duration-300 hover:-translate-y-1 active:translate-y-0 active:scale-[0.98]"
            >
              ...
              <div className="flex items-center justify-between gap-2 p-4">
                ...
                <ArrowUpRight
                  className="size-4 shrink-0 text-dim transition-colors group-hover:text-signal group-active:text-signal"
                  strokeWidth={2}
                />
              </div>
            </Link>
